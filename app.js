var all={
tabriz:{naem:'whather in tabriz',dgree:'9*C',wether:'ice.png',humidity: "5*",windspeed:'15*'},
tahran:{naem:'whather in tahran',dgree:'19*C',wether:'rainy.png',humidity: "12*",windspeed:'40*'},
shiraz:{naem:'whather in shiraz',dgree:'29*C',wether:'suny.png',humidity: "24*",windspeed:'10*'},
}
